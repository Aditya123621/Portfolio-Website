...
const Contact = () => {
  ...
  function submitForm(event) {
    ...
    // For example, you can access form field values using event.target.elements
      ...
      >
        <div className="container">
          <div className="row d-flex py-4">
            ...
            <a href={`tel:${data.phone}`} className="all-link">
              <div
            ...
            <div className="col-lg-4 mb-3">
            <a href={`mailto:${data.email}`} className="all-link">
              <div
                className={`contact-info-item py-3 px-3 d-flex align-items-center  ${
                  theme ? "contact-info-item-dark" : "contact-info-item-light"
                }`}
